      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              {/* Avatar */}
              <div className="mb-3 sm:mb-4 inline-block p-3 sm:p-4 bg-primary-green/10 rounded-full group-hover:ring-2 group-hover:ring-primary-green transition-all duration-300 overflow-hidden w-32 h-32 sm:w-36 sm:h-36">
                <img 
